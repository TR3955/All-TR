...
async function getHelpMenu({ client, guild }) {
  ...
  const supportButton = new ButtonBuilder()
    ...
    .setURL("https://discordapp.com/users/1351845223642300487");
...
<:search:1362988723737723152> Utility `,
    ...
    .setDescription(`<a:loading:1363179590851493958> **nikznode Official bot is here to help. \n > It is a multipourpose bot for your discord. \n > It can help you to build a Super server.**
...
> <:circle:1362988697338773765> Modified by \`TRgaming3955\``);
